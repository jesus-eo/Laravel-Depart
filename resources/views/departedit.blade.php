...
<div class="mb-6">
    ...
    <input type="text" name="denominacion" id="denominacion"
        ...
        " value="{{ old('denominacion', $departamento->denominacion) }}">{{-- @error('denominacion') border-red-500 @enderror" --}}
        @error('denominacion')
...
<div class="mb-6">
    ...
    <input type="text" name="localidad" id="localidad"
        class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 {{-- @error('localidad') border-red-500 @enderror --}}" value="{{ old('localidad', $departamento->localidad) }}">
...
<a href="/" class="text-white border-green-700 border-2 bg-green-700 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Volver</a>
</form>
</x-layout>
